...
// 가짜벡엔드(json-server) : http://loaclhost:8000
// 자원(resource)url : /dept
// 사용 예) http://localhost:8000/dept
// 이 파일에서는 기본주소만 설정하고  http://loaclhost:8000
// 다른 파일에서 추가 url 설정 : http://localhost:8000/dept

// 1) 통신 라이브러리 추가 : import
import axios from "axios";
// 2) 기본 주소 설정 : 가짜 백엔드(http://loaclhost:8000)
